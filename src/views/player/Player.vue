    ...
    <el-row style="padding-top: 12px" :gutter="20"><!--gutter为栅格的间隔-->
      ...
      <el-col :md="15">
        ...
        <p-video
          v-if="showVideo"
          v-loading="video.url"
          :video-url="baseURL + video.vurl"
          :cover-url="baseURL + video.coverurl"
      ...
      <el-col :md="9">
        ...
        <el-row v-for="(item,index) in videos" :key="index" class="item" :title="item.vname" @click.native="toPlayer(item)">
          <div class="content">
